...
const Coupon = () => {
  ...
  const submitHandler = (e: FormEvent<HTMLFormElement>) => {
    ...
    for(let i = 0; i<loopLength; i++) {
      ...
      // The double tilde (~~) is a bitwise operation that performs a fast truncation towards zero, 
      // effectively removing the decimal part and leaving only the integer part.
